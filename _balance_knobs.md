...
### 11. Card Fusion (механизм, фундамент Химика, С49) — `core/fusion.py`
Чистый class-agnostic механизм слияния двух карт в «Глитч-карту». ИНЕРТЕН (никто не
зовёт), пока класс/реликвия не активирует доступ. Тормоз мощности — РЕСУРС класса
(Реагент, этап 2), а не цена розыгрыша. Спека: `_card_fusion_design.md`.
