...
class GameManager:
    ...
    def __init__(self):
        ...
        self.relics        = []
        # Per-run бан тегов ковки (бонус L3 Грейда): tag_id, запрещённые в драфте
        # майлстоунов на ЭТОТ забег. Сбрасывается на старте забега (HubView).
        self.run_banned_tags: list = []
