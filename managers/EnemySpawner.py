...
# ЗАКРЕПЛЕНО С67 (капстоун): проба чувствительности (soft 1.026/1.024 → hard 1.030/1.028)
# показала wall тройки ПОЧТИ ПЛОСКИМ (Воин 29→29→27; Берс пиннится 7; Маг — шум) — на
# диапазоне ранней стены метрика к ±0.002 малочувствительна, форма (Воин>Маг>Берс)
# держится. Текущая = осознанный якорь удвоения ~23 этажа; двигать = перетюн всей игры.
