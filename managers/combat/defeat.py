...
class DefeatMixin:
    ...
    def check_player_defeat(self) -> bool:
        ...
        (_hp_floor() = hp_debt_floor(max_hp) = −50% max HP, С57 — процент, не флат) —
        игрок ВЫЖИВАЕТ в минусе (долг жизни даёт множитель урона), смерть наступает лишь
        на ДНЕ долга. Без флага пол = 0 → байт-в-байт."""
