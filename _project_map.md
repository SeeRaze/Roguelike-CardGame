...
- **SummonerAbility «Подкрепление»** (Сессия 32, каркас): призвать Волка (HP 12, Атака 4) в `allies`. Один раз за бой.
...
- ⚠️ Текущий бот ГОЛЫЙ (без прогрессии колоды/реликвий) → упирается в стену ~6 этажа.
  TODO Сессии 33: прогрессия бота + фикс Друида + перезамер (см. PATCHNOTES / память).
