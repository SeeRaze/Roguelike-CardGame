...
Реликвии — 31 итого. **Контракт редкости** (рамка калибровки) — module-docstring в
...
- UNCOMMON (7): ДревнееОгниво, НамокшаяРукавица, ОкровавленныйШприц, ФлаконСЖелчью, СвинцовыйНабалдашник, ШипастаяБроня, ТрофейныйКлык
- RARE (5): ЭнергоЯдро, СердцеТитана, ГнилойКлык, ЖелезнаяВоля, БерсеркМедальон
- EPIC (4): КоронаВознесения (`persistent.py` — растущая, ×1.25 урон/босс по забегу), СердцеБездны (+15% макс.HP/босс), ЭхоВечности (Эхо в начале хода), НесокрушимыйБастион (+50% щита как Барьер)
