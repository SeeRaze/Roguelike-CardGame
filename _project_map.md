...
- NB: Воин/Маг в baseline → числа сдвигаются (Воин wall +5, Маг ~нейтр.). Бонус-мощь
  Мага под-реализован «стеной» (бот не пилотирует высокое Мастерство). Калибровка +
  бот-политика — следующий шаг.
