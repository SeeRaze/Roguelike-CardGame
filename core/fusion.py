...
# Цена одного слияния в РЕАГЕНТЕ (ресурс-тормоз Химика). Главная баланс-ручка темпа
# фьюжна вместе с притоком REAGENT_PER_TURN. Ручка — _balance_knobs.md.
FUSION_REAGENT_COST = 1
