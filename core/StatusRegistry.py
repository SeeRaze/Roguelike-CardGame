STATUSES = {
    ...
    "regen": {
        ...
        "tooltip":     "Вампиризм: каждая атака восстанавливает 50% урона. Стак: N. Убывает вдвое после каждого триггера.",
        "keyword":     ("Вампиризм", "Каждая атака восстанавливает 50%\nнанесённого урона. Стак: N.\nУбывает вдвое после триггера."),
        "is_duration": False,
        "is_stack":    True,
    }
}
