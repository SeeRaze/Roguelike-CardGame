...
# Механика: в начале хода «пожирает» накопленные НА СЕБЕ стаки Legacy-кода,
# суммарно до DEVOUR_CAP за ход, и конвертирует съеденное в лечение.
# Стакающие Legacy-DoT билды кормят его. Кап →
