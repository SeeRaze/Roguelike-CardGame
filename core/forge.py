...
TEMPER_GOLD_COST       = 60         # цена Закалки в ЗОЛОТЕ. 60 = реальный ранний выбор vs
                                    # реликвия (золото ~23-95/бой в акте 1); плоская цена =
                                    # намеренный поздний компаунд (+20% от растущего max_hp).
