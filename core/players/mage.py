...
def get_mage_deck():
    ...
    # Автопилот (гамбл HP→Мастерство) + Сгенерить фичу (выжать глубину). Залить в прод/
    # Вайб-сессия/Удачный промпт — в драфт-пуле (catalog).
    ...
    return [
        ...
        create_overclock(),             # Автопилот: гамбл HP → Мастерство
        create_resonant_discharge(),    # Сгенерить фичу: урон от глубины Мастерства
    ]
