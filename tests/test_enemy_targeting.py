...
# Случайный таргетинг атак врага: атакующее намерение бьёт СЛУЧАЙНУЮ цель из
# {игрок + живые союзники}. Фундамент под будущий статус «провокация» и под
# призывные классы (союзники поглощают часть ударов).
#
